<div class="container mx-auto px-4 py-8 max-w-2xl">
    <div class="bg-white rounded-lg shadow-md p-6">
        <h1 class="text-2xl font-bold mb-6">Create New Sector</h1>
        ...
        <form wire:submit.prevent="createSector">
            <div class="space-y-6">
                <div>
        ...
        <div class="mt-6">
            <a href="{{ route('sectors.index') }}" class="text-indigo-600 hover:text-indigo-900">
                ← Back to Sectors
            </a>
        </div>
    </div>
