<div class="container mx-auto px-4 py-8 max-w-2xl">
    <div class="bg-white rounded-lg shadow-md p-6">
        <h1 class="text-2xl font-bold mb-6">Edit Data Entry</h1>
            ...
            <div class="space-y-6">
                ...
                <div class="flex justify-between">
                    ...
                    <button type="button" wire:click="deleteData"
                            class="flex-1 flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 mr-2"
                            onclick="return confirm('Are you sure you want to delete this data entry?')">
                        Delete
                    </button>
