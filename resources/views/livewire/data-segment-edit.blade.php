<div class="container mx-auto px-4 py-8 max-w-2xl">
    <div class="bg-white rounded-lg shadow-md p-6">
        <h1 class="text-2xl font-bold mb-6">Edit Data Segment</h1>
        ...
        <form wire:submit.prevent="updateDataSegment">
            <div class="space-y-6">
                <div>
        ...
        <div class="mt-6">
            <button wire:click="deleteDataSegment" 
                    onclick="return confirm('Are you sure you want to delete this data segment?')"
